...
init:
    ...
    MIZ 0 _YPos MIZ 7 _XPos JPS _Print " ------- ELIZA v1.0 for Minimal64x4 -------" 0
...
start:
    ...
    keyword_search_loop:
            ...
            JPS keyword_search                      ; searching for keyword
                ...
                INZ Z6                              ; just to be sure check second byte of this pointer (at end should be 0x0000)
    ...
    ; *** checking for an reply related to keyword
        ...
        LDR keyword_temp_ptr  STB repl_ptr          ; read and store reply pointer
        INW keyword_temp_ptr
        LDR keyword_temp_ptr  STB repl_ptr+1        ; found reply is now pointed by reply_ptr
    ...
    ; *** updating answer pointer to next answer for future
        ABW found_keyword_length keyword_ptr        ; skip keyword itself
        INW keyword_ptr                             ; skip zero byte EOS
        LDR repl_ptr  STR keyword_ptr               ; update reply pointer with a new one, first byte
        INW keyword_ptr
        INW repl_ptr
        LDR repl_ptr  STR keyword_ptr               ; update reply pointer with a new one, second byte
    ...
    ; *** copying everything from input after found keyword to second buffer for further conjugation
        ...
        MBB kws_buf_ptr+1   temp_ptr+1              ; using temp pointer to avoid messin with other pointers
        ...
        DEW temp_ptr                                ; stepping back one letter in case keyword definition itself ends with space
            ...
            eow_check_loop_end: MIW second_buffer   copy_dst_ptr
                                ...
                                JPS copy_strings    ; now everything was after keyword is in second buffer
                                                    ;   MIW second_buffer pb_ptr  JPS print_buffer  ; temporary print for troubleshooting
    ...
    pronoun_swap_main_loop:                         ; this loop goes on for each pronoun pair until end of pronoun pointers list
        ...
        pronoun_swap_loop1:                         ; this loop goes thorug all the letters in second buffer copies letters from second buffer to temp buffer
        ...
        pronoun_swap_buffer_end:
            MIR 0 tmp_buf_tmp_ptr                   ; putting zero at the new end of processed buffer
...
;   *************************************
                ...
                ; *************************************
keywords:   kw01 kw02 kw03 kw04 kw05 kw06 kw07 kw08 kw09 kw10 kw11 kw12 kw13 kw14 kw15 kw16 kw17 kw18 kw19 kw20
            kw21 kw22 kw23 kw24 kw25 kw26 kw27 kw28 kw29 kw30 kw31 kw32 kw33 kw34 kw35 0x0000
kw01: "CAN YOU" 0       repl001
kw02: "CAN I" 0         repl004
kw03: "YOU ARE" 0       repl006
kw04: "YOURE" 0         repl006
...
kw_nf:  0 repl_nf01
                ...
                ; *************************************
pronoun_a:  pron_are,   pron_were,  pron_you,   pron_your,  pron_ive,   pron_im,    0x0000
pronoun_b:  pron_am,    pron_was,   pron_i,     pron_my,    pron_youve, pron_youre, 0x0000
pron_are:   " ARE "     0
pron_am:    " AM "      0
pron_were:  "WERE "     0
pron_was:   "WAS "      0
...
repl005: repl004 "DO YOU WANT TO BE ABLE TO*" 0
;                 you are,youre
...
repl016: repl014 "DO YOU ENJOY FEELING*" 0
;                 why dont you
...
repl024: repl022 "PERHAPS IN YOUR FANTASIES I AM*" 0
;                 i cant
...
repl031: repl032 "DO YOU ENJOY BEING*" 0
;                 you
...
repl048: repl040 "WHAT ELSE COMES TO MIND WHEN YOU ASK THAT?" 0
;                 name
...
repl058: repl055 "DON'T BE SO DEFENSIVE!" 0
;                 dream
...
repl062: repl059 "ARE YOU DISTURBED BY YOUR DREAMS?" 0
;                 hello hi
repl063: repl063 "HOW DO YOU DO... PLEASE STATE YOUR PROBLEM." 0
;                 maybe
...
repl068: repl064 "DON'T YOU KNOW?" 0
;                 no
...
repl075: repl074 "WHAT ABOUT YOUR OWN*" 0
;                 always
...
repl_nf07: repl_nf01 "THAT IS QUITE INTERESTING." 0
